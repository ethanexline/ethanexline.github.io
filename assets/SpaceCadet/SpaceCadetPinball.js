...
(function() {
    var loadPackage = function(metadata) {
        ...
        var REMOTE_PACKAGE_BASE = "assets/SpaceCadet/SpaceCadetPinball.data";
...
if (ENVIRONMENT_IS_NODE) {
    ...
    setWindowTitle = function(title) {
        document.title = "Time to get weird."
    }
} else {}
...
var ASM_CONSTS = {
    ...
    3406205: function($0, $1, $2, $3) {
        ...
        var have_microphone = function(stream) {
            ...
            SDL2.capture.audioWorkletNode = SDL2.audioContext.createScriptProcessor($1, $0, 1);
            SDL2.capture.audioWorkletNode.onaudioprocess = function(audioProcessingEvent) {
            ...
            SDL2.capture.mediaStreamNode.connect(SDL2.capture.audioWorkletNode);
            SDL2.capture.audioWorkletNode.connect(SDL2.audioContext.destination);
    ...
    3407857: function($0, $1, $2, $3) {
        var SDL2 = Module["SDL2"];
        SDL2.audio.audioWorkletNode = SDL2.audioContext["createScriptProcessor"]($1, 0, $0);
        SDL2.audio.audioWorkletNode["onaudioprocess"] = function(e) {
        ...
        SDL2.audio.audioWorkletNode["connect"](SDL2.audioContext["destination"])
    },
    ...
    3409352: function($0) { //*** important??
        ...
        if ($0) {
            ...
            if (SDL2.capture.audioWorkletNode !== undefined) {
                SDL2.capture.audioWorkletNode.onaudioprocess = function(audioProcessingEvent) {};
                SDL2.capture.audioWorkletNode.disconnect();
                SDL2.capture.audioWorkletNode = undefined
            }
            ...
            if (SDL2.audio.audioWorkletNode != undefined) {
                SDL2.audio.audioWorkletNode.disconnect();
                SDL2.audio.audioWorkletNode = undefined
            }
