...
function toggleTheme() {
    ...
    if (styleChanger.value == '1') {
        ...
        bodyPic[0].setAttribute('style', "overflow: hidden; font-family: Tahoma, sans-serif; min-height: 100%; background-position: left; " +
            "background-size: " + window.innerWidth + "px " + "100vh; background-color: white; background-image: url('assets/images/win98.webp'); " +
            "max-width: 100vw;");
        ...
        bodyPic[0].setAttribute('style', "overflow: hidden; font-family: 'Franklin Gothic', sans-serif; min-height: 100%; background-position: left; " +
            "background-size: " + window.innerWidth + "px " + "100vh; background-color: white; background-image: url('assets/images/bliss.webp'); " +
            "max-width: 100vw;");
        startBar.style.display = "flex";
        startBar.className = "";
        ...
        bodyPic[0].setAttribute('style', "overflow: hidden; font-family: 'Segoe UI', sans-serif; min-height: 100%; background-position: left; " +
            "background-size: " + window.innerWidth + "px " + "100vh; background-color: white; background-image: url('assets/images/win7default.webp'); " +
            "max-width: 100vw;");
        startBar.style.display = "flex";
        startBar.className = "";
